...
let client;
let channel;
let queryString = window.location.search;//location of window stand room
// console.log("line 11 "+queryString);
...
let init = async () => {
  ...
  console.log("hi from init   "+localStream)
...
let setting = async () => {
  ...
  if (setn.style.display == "block") {
    ...
    document.getElementById("setting-btn").style.backgroundColor =
      "#a15ce1";
  } else {
    document.getElementById("setting-btn").style.backgroundColor =
      "#ff5050";
